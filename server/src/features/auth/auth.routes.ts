...
import { signupController, loginController, forgotPasswordController, resetPasswordController, walletChallengeController, walletLinkController, walletLoginController, changePasswordController } from '@/features/auth/auth.controller.js';
